...
describe('ForSaleComponent', () => {
  ...
  let mockForSaleService;
  let mockDataService

  beforeEach(async(() => {

    mockForSaleService = sinon.createStubInstance(ForSaleService);
    mockForSaleService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: ForSaleService, useValue: mockForSaleService },
